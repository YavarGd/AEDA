...
public sealed class AvaloniaThemeManager : IDisposable
{
    ...
    private void ApplyCurrent()
    {
        ...
        SetBrush(application, "ToggleButtonBackgroundChecked", palette.Accent);
        SetBrush(application, "ToggleButtonBackgroundCheckedPointerOver", palette.AccentHover);
        SetBrush(application, "CheckBoxCheckBackgroundFillChecked", palette.Accent);
        SetBrush(application, "CheckBoxCheckBackgroundStrokeCheckedPointerOver", palette.AccentHover);
        SetBrush(application, "CheckBoxCheckBackgroundFillCheckedPointerOver", palette.AccentHover);
        SetBrush(application, "CheckBoxCheckBackgroundStrokeCheckedPressed", palette.AccentPressed);
        SetBrush(application, "CheckBoxCheckBackgroundFillCheckedPressed", palette.AccentPressed);
        SetBrush(application, "RadioButtonOuterEllipseCheckedStroke", palette.Accent);
        SetBrush(application, "RadioButtonOuterEllipseCheckedFill", palette.Accent);
        SetBrush(application, "RadioButtonOuterEllipseCheckedStrokePointerOver", palette.AccentHover);
        SetBrush(application, "RadioButtonOuterEllipseCheckedFillPointerOver", palette.AccentHover);
        SetBrush(application, "RadioButtonOuterEllipseCheckedStrokePressed", palette.AccentPressed);
        SetBrush(application, "RadioButtonOuterEllipseCheckedFillPressed", palette.AccentPressed);
        SetBrush(application, "TabItemHeaderSelectedPipeFill", palette.Accent);
